...
if (len(sys.argv) != 2) or (not sys.argv[1].endswith('.cu')):
    with contextlib.redirect_stdout(sys.stderr):
        ...
        print()
        print('   # Subbanded dedispersion kernel.')
        print('   autogenerate_kernel.py src_lib/autogenerated_kernels/sbdd_r8_n5_n9_n7_n3_n1.cu')
        print()
...
elif basename.startswith('sbdd_'):
    cls = cuda_generator.SbDedisperser
