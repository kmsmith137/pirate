...
template<> __device__ float* _shmem_base<float> () { extern __shared__ float shmem_f[]; return shmem_f; }
template<> __device__ __half2* _shmem_base<__half2> () { extern __shared__ __half2 shmem_h2[]; return shmem_h2; }
...
template<typename T>
__device__ void dd_sum(T &x0, T &x1, T y, T z)
{
    x0 = z + x1;
    x1 += y;
}
...
__device__ void dd_step(float &x0, float &x1, float &rs)
{
    static_assert(N >= 0);
    static_assert(N < 32);
...
template<int C>
__device__ void dd_r1(float &x0, float &x1, float &rs)
{
...
template<int C>
__device__ void dd_r2(float &x0, float &x1, float &x2, float &x3, float &rs)
{
...
template<int C>
__device__ void dd_r3(float &x0, float &x1, float &x2, float &x3,
...
template<int C>
__device__ void dd_r4(float &x0, float &x1, float &x2, float &x3,
		      float &x4, float &x5, float &x6, float &x7,
...
template<int N, int C>
__device__ __half2 lag_half2(__half2 x, __half2 &rs)
{
    const int laneId = (threadIdx.x & 0x1f);
...
template<int C>
__device__ void dd_r1(__half2 &x0, __half2 &x1, __half2 &rs)
{
...
template<int C>
__device__ void dd_r1_s2(__half2 &x00, __half2 &x10, __half2 &x01, __half2 &x11, __half2 &rs)
{
...
__device__ void dd_r2_top(__half2 &x0, __half2 &x1, __half2 &x2, __half2 &x3, __half2 &rs)
{
...
template<int C>
__device__ void dd_r2(__half2 &x0, __half2 &x1, __half2 &x2, __half2 &x3, __half2 &rs)
{
...
template<int C>
__device__ void dd_r2_s2(__half2 &x00, __half2 &x10, __half2 &x20, __half2 &x30,
...
__device__ void dd_r3_top(__half2 &x0, __half2 &x1, __half2 &x2, __half2 &x3,
...
template<int C>
__device__ void dd_r3(__half2 &x0, __half2 &x1, __half2 &x2, __half2 &x3,
		      __half2 &x4, __half2 &x5, __half2 &x6, __half2 &x7,
		      __half2 &rs)
{
...
__device__ void dd_r3_s2(__half2 &x00, __half2 &x10, __half2 &x20, __half2 &x30,
...
template<int C>
__device__ void dd_r4(__half2 &x0, __half2 &x1, __half2 &x2, __half2 &x3,
		      __half2 &x4, __half2 &x5, __half2 &x6, __half2 &x7,
...
__device__ int rb_advance(int rb_pos, int rb_size, int step)
{
    rb_pos += step;
...
// The next device-side helepr functions are for applying one-sample lag.
...
template<int C>
__device__ void align1_s2(__half2 &x, __half2 &y, __half2 &rs)
{
...
template<int C>
__device__ void align1_s4(__half2 &x0, __half2 &x1, __half2 &x2, __half2 &x3, __half2 &rs)
{
...
template<int C>
__device__ void align1_s8(__half2 &x0, __half2 &x1, __half2 &x2, __half2 &x3,
			  __half2 &x4, __half2 &x5, __half2 &x6, __half2 &x7,
			  __half2 &rs)
{
