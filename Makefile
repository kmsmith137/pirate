...
GRPC_CPP_GENERATED := grpc/frb_search.pb.cc grpc/frb_search.pb.h grpc/frb_search.grpc.pb.cc grpc/frb_search.grpc.pb.h

# Python generated files (protobuf message classes + gRPC service stubs)
GRPC_PY_GENERATED := pirate_frb/rpc/grpc/frb_search_pb2.py pirate_frb/rpc/grpc/frb_search_pb2_grpc.py
...
LIB_SRCFILES = \
  ...
  grpc/frb_search.pb.cc \
  grpc/frb_search.grpc.pb.cc
...
PYFILES = \
  ...
  pirate_frb/rpc/grpc/frb_search_pb2.py \
  pirate_frb/rpc/grpc/frb_search_pb2_grpc.py
...
CLEAN_FILES := sdist_files.txt wheel_files.txt makefile_helper.out pirate_frb/include pirate_frb/lib $(AUTOGENERATED_KERNELS) $(GRPC_CPP_GENERATED) $(GRPC_PY_GENERATED)

# Directories that should be empty at the end of 'make clean', and can be deleted.
CLEAN_RMDIRS := lib pirate_frb/__pycache__ pirate_frb/casm/__pycache__ pirate_frb/core/__pycache__ pirate_frb/kernels/__pycache__ pirate_frb/loose_ends/__pycache__ pirate_frb/utils/__pycache__ pirate_frb/cuda_generator/__pycache__ pirate_frb/rpc/__pycache__ pirate_frb/rpc/grpc/__pycache__ pirate_frb/rpc/grpc pirate_frb/rpc
...
# Convert .cu, .cpp, and .cc source files to .o object files
LIB_OFILES_CU := $(filter %.cu,$(LIB_SRCFILES))
LIB_OFILES_CPP := $(filter %.cpp,$(LIB_SRCFILES))
LIB_OFILES_CC := $(filter %.cc,$(LIB_SRCFILES))
LIB_OFILES := $(LIB_OFILES_CU:%.cu=%.o) $(LIB_OFILES_CPP:%.cpp=%.o) $(LIB_OFILES_CC:%.cc=%.o) $(AUTOGENERATED_OFILES)
...
DEPFILES := $(ALL_SRCFILES_CU:%.cu=%.d) $(ALL_SRCFILES_CPP:%.cpp=%.d) $(ALL_SRCFILES_CC:%.cc=%.d)
...
grpc: $(GRPC_CPP_GENERATED) $(GRPC_PY_GENERATED)

# Generate C++ protobuf and gRPC files from .proto
# All four C++ files are generated by a single protoc invocation.
# We use a sentinel file pattern: the .pb.cc file is the "primary" target.
grpc/frb_search.pb.cc grpc/frb_search.grpc.pb.cc: $(GRPC_PROTO)
	protoc --cpp_out=grpc --grpc_out=grpc \
	  --plugin=protoc-gen-grpc=$$(which grpc_cpp_plugin) \
	  -I grpc frb_search.proto

# The .pb.h and .grpc.pb.h files are generated alongside the .cc files
grpc/frb_search.pb.h: grpc/frb_search.pb.cc
grpc/frb_search.grpc.pb.h: grpc/frb_search.grpc.pb.cc

# Generate Python protobuf and gRPC stubs from .proto
# Both Python files are generated by a single grpc_tools.protoc invocation.
# The sed command fixes the import in the _grpc.py file to use relative imports.
pirate_frb/rpc/grpc/frb_search_pb2.py pirate_frb/rpc/grpc/frb_search_pb2_grpc.py: $(GRPC_PROTO)
	...
	$(PYTHON) -m grpc_tools.protoc \
	  ...
	  frb_search.proto
	sed -i 's/^import frb_search_pb2/from . import frb_search_pb2/' pirate_frb/rpc/grpc/frb_search_pb2_grpc.py
