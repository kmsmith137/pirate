...
#
# Special targets for sphinx docs, but note that sphinx docs are currently
# placeholders, that are not useful yet:
#
#   make docs
#   make docs-clean
#   make docs-serve
...
.PHONY: all lib build_wheel build_sdist clean docs docs-clean docs-serve pybind11 autogenerated_kernels gddk gpfk pfom pfwr cdd2
...
CLEAN_RMDIRS := lib pirate_frb/__pycache__ pirate_frb/casm/__pycache__ pirate_frb/core/__pycache__ pirate_frb/kernels/__pycache__ pirate_frb/loose_ends/__pycache__ pirate_frb/cuda_generator/__pycache__

####################################################################################################


AUTOGENERATED_OFILES := $(AUTOGENERATED_KERNELS:%.cu=%.o)
LIB_OFILES := $(LIB_SRCFILES:%.cu=%.o) $(AUTOGENERATED_OFILES)
