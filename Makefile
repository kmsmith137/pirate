...
OFFLINE_GROUPER_EXAMPLE = configs/grouper/example.yml
...
SDIST_FILES += examples/chord_8beams/observation.yml
...
SDIST_FILES += examples/README.md examples/simple_frb/README.md examples/chord_8beams/README.md
...
WHEEL_FILES += $(OFFLINE_PEAK_TEST_DATA)
