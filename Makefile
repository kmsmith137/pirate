...
CLEAN_FILES := sdist_files.txt wheel_files.txt makefile_helper.out pirate_frb/include pirate_frb/lib $(AUTOGENERATED_KERNELS) $(GRPC_CCFILES) $(GRPC_HFILES) $(GRPC_PYFILES) grpc/*.protoc_*_sentinel asdf-cxx/include/asdf/config.hxx pirate_frb/rpc/grpc/__init__.pyi notes/*.aux notes/*.log notes/*.out notes/*.toc notes/*.pdf
...
CLEAN_RMDIRS := lib pirate_frb/__pycache__ pirate_frb/casm/__pycache__ pirate_frb/chime/__pycache__ pirate_frb/core/__pycache__ pirate_frb/slow_avar/__pycache__ pirate_frb/fast_avar/__pycache__ pirate_frb/kernels/__pycache__ pirate_frb/loose_ends/__pycache__ pirate_frb/utils/__pycache__ pirate_frb/cuda_generator/__pycache__ pirate_frb/rpc/__pycache__ pirate_frb/rpc/grpc/__pycache__
