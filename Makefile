...
LIB_SRCFILES = \
  ...
  src_lib/test_avx256_m64_outbuf.cu \
  src_lib/test_cpu_downsampler.cu \
  src_lib/test_gpu_downsample.cu \
  src_lib/test_gpu_reduce2.cu \
  src_lib/test_gpu_transpose.cu \
