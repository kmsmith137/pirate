...
CLEAN_FILES := sdist_files.txt wheel_files.txt makefile_helper.out pirate_frb/include pirate_frb/lib $(AUTOGENERATED_KERNELS) $(GRPC_CCFILES) $(GRPC_HFILES) $(GRPC_PYFILES) $(GRPC_SENTINELS)
...
LIB_OFILES := $(LIB_OFILES_CU:%.cu=%.o) $(LIB_OFILES_CPP:%.cpp=%.o) $(AUTOGENERATED_OFILES) $(GRPC_OFILES)
...
ALL_SRCFILES := $(LIB_SRCFILES) $(PYEXT_SRCFILES) $(AUTOGENERATED_KERNELS) $(GRPC_CCFILES)
...
grpc/frb_search.protoc_cpp_sentinel: grpc/frb_search.proto
	protoc --cpp_out=grpc --grpc_out=grpc \
	  --plugin=protoc-gen-grpc=$$(which grpc_cpp_plugin) \
	  -I grpc frb_search.proto
	touch $@

# All generated C++ files depend on the sentinel
grpc/frb_search.pb.cc grpc/frb_search.pb.h grpc/frb_search.grpc.pb.cc grpc/frb_search.grpc.pb.h: grpc/frb_search.protoc_cpp_sentinel
...
grpc/frb_search.protoc_python_sentinel: grpc/frb_search.proto
...
# All generated Python files depend on the sentinel
pirate_frb/rpc/grpc/frb_search_pb2.py pirate_frb/rpc/grpc/frb_search_pb2_grpc.py: grpc/frb_search.protoc_python_sentinel
