...
.PHONY: all lib build_wheel build_sdist clean docs docs-clean docs-serve tex pybind11 autogenerated_kernels gddk gpfk pfom pfwr cdd2 sbdd help grpc
...
help:
	...
	@echo "  sbdd             - Build subbanded dedispersion kernels (sbdd_*.o)"
...
docs-clean:
	rm -rf docs/build docs/source/notes docs/source/configs docs/source/grpc docs/source/cli docs/source/_cli_generated.md docs/source/_grpc_generated.md docs/source/_static/*.pdf
...
PYEXT_SRCFILES = \
  ...
  src_pybind11/pirate_pybind11_chimefrb.cpp \
...
PYFILES = \
  ...
  pirate_frb/varmap/mc.py \
  pirate_frb/varmap/report.py \
  pirate_frb/varmap/tests.py \
  pirate_frb/fast_varmap/__init__.py \
...
CUDAGEN_PYFILES = \
  ...
  pirate_frb/cuda_generator/SbDedisperser.py \
...
CLEAN_DIRS := . lib src_lib src_lib/chimefrb src_lib/loose_ends src_lib/template_instantiations src_lib/autogenerated_kernels src_pybind11 grpc pirate_frb pirate_frb/__pycache__ pirate_frb/casm pirate_frb/casm/__pycache__ pirate_frb/chime pirate_frb/chime/__pycache__ pirate_frb/chimefrb pirate_frb/chimefrb/__pycache__ pirate_frb/core pirate_frb/core/__pycache__ pirate_frb/varmap pirate_frb/varmap/__pycache__ pirate_frb/fast_varmap pirate_frb/fast_varmap/__pycache__ pirate_frb/simpulse pirate_frb/simpulse/__pycache__ pirate_frb/kernels pirate_frb/kernels/__pycache__ pirate_frb/loose_ends pirate_frb/loose_ends/__pycache__ pirate_frb/cuda_generator/__pycache__ pirate_frb/rpc pirate_frb/rpc/__pycache__ pirate_frb/rpc/grpc pirate_frb/rpc/grpc/__pycache__ include include/pirate include/pirate/chimefrb include/pirate/loose_ends include/pirate/cuda_kernels asdf-cxx/src
...
CLEAN_RMDIRS := lib pirate_frb/__pycache__ pirate_frb/casm/__pycache__ pirate_frb/chime/__pycache__ pirate_frb/chimefrb/__pycache__ pirate_frb/core/__pycache__ pirate_frb/varmap/__pycache__ pirate_frb/fast_varmap/__pycache__ pirate_frb/simpulse/__pycache__ pirate_frb/kernels/__pycache__ pirate_frb/loose_ends/__pycache__ pirate_frb/cuda_generator/__pycache__ pirate_frb/rpc/__pycache__ pirate_frb/rpc/grpc/__pycache__

####################################################################################################


# src_lib/autogenerated_kernels/debug.cu is a build-time debugging "hook": an empty .cu file
# recreated by the 'touch' rule below (it does not exist in a clean tree). Like the autogenerated
# kernels, it is compiled into libpirate.so but NOT shipped in the sdist -- a source build
# recreates it. We therefore keep it out of LIB_SRCFILES (which feeds SDIST_FILES) and group it
# with the autogenerated object files here.
DEBUG_KERNEL := src_lib/autogenerated_kernels/debug.cu

AUTOGENERATED_OFILES := $(AUTOGENERATED_KERNELS:%.cu=%.o) $(DEBUG_KERNEL:%.cu=%.o)
...
ALL_SRCFILES := $(LIB_SRCFILES) $(PYEXT_SRCFILES) $(AUTOGENERATED_KERNELS) $(DEBUG_KERNEL) $(GRPC_CCFILES) $(ASDF_CXX_SRCFILES)
...
# Note that autogenerated files are not included in the sdist. This includes debug.cu, which is
# grouped with the autogenerated kernels (see DEBUG_KERNEL above) rather than LIB_SRCFILES, so a
# plain $(LIB_SRCFILES) here already excludes it (a source build recreates it via the 'touch' rule).
...
sbdd: $(filter src_lib/autogenerated_kernels/sbdd_r%.o, $(AUTOGENERATED_OFILES))
