...
CLEAN_FILES := sdist_files.txt wheel_files.txt makefile_helper.out pirate_frb/include pirate_frb/lib $(AUTOGENERATED_KERNELS) $(GRPC_CCFILES) $(GRPC_HFILES) $(GRPC_PYFILES) grpc/*.protoc_*_sentinel asdf-cxx/include/asdf/config.hxx pirate_frb/rpc/grpc/__init__.pyi
