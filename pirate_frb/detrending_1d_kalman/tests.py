...
def _default_rng(rng):
    """Unseeded by choice: repeated runs explore different data rather than
    re-checking one fixture.  run_all() prints the entropy of the generator it
    creates, which is enough to reproduce a failing run."""
