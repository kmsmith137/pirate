...
class PfWeightReader:
    ...
    def write_test_kernel(cls, filename):
        ...
        fs = pf_weight_reader.frequency_subbands
        ...
        k.emit(f'v.pf_weight_layout.dtype =  ksgpu::Dtype::native<{dtype.scalar}>();')
        k.emit(f'v.pf_weight_layout.F = {pf_weight_reader.F};')
        k.emit(f'v.pf_weight_layout.P = {pf_weight_reader.P};')
        k.emit(f'v.pf_weight_layout.Pouter = {pf_weight_reader.Pouter};')
        k.emit(f'v.pf_weight_layout.Pinner = {pf_weight_reader.Pinner};')
        k.emit(f'v.pf_weight_layout.Tinner = {pf_weight_reader.Tinner};')
        k.emit(f'v.pf_weight_layout.touter_byte_stride = {pf_weight_reader.weight_layout.touter_byte_stride};')
        ...
        k.emit(f'xassert_eq(fs.F, {pf_weight_reader.F});')
        k.emit(f'xassert_eq(fs.M, {pf_weight_reader.M});')
