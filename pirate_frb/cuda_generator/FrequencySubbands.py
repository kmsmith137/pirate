...
class FrequencySubbands:
    def __init__(self, subband_counts):    
        ...
        # For kernel/file names in code generator. Note that leading zeros are never stripped:
        # 'n0_n0_n3_n2_n1' and 'n3_n2_n1' are different band sets (the first has no bands at
        # its two lowest levels), hence different kernels.
