"""GpuDetrenderLps1d method injections (+ re-export of the pybind11 class)."""

import ksgpu
from ..pirate_pybind11 import GpuDetrenderLps1d


@ksgpu.inject_methods(GpuDetrenderLps1d)
class GpuDetrenderLps1dInjections:
    # No class docstring here: GpuDetrenderLps1d's docstring lives in the pybind11
    # binding (option 1 in notes/docstrings.md); this injector adds a stream
    # argument for launch().

    # Save reference to C++ method
    _cpp_launch = GpuDetrenderLps1d.launch
