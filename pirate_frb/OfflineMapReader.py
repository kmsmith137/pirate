...
of :class:`OfflineMapReader` validates all files and reconstructs the exact
producer plan from the serialized configuration and plan YAML.  A later call
to :meth:`OfflineMapReader.load_beam_chunk` copies one bounded collection of
...
__all__ = ["BeamBatch", "OfflineMapReader", "GpuMapChunk"]
