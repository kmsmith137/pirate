...
def _group_streaming_window(
    ...
    function = cluster_candidates if group_function is None else group_function
    grouped = function(
        decoded,
        grouping_geometry,
...
class StreamingGrouper:
    ...
    def __init__(self, geometries, decoder, grouping_geometry, *, beam_ids,
        ...
        factory = StreamingPeakExtractor if extractor_factory is None else extractor_factory
...
class GrouperSetup:
    ...
    def __init__(self, plan, dcores, configuration, *, cuda_device_id):
        ...
        self.grouping_geometry = ClusteringGeometry.from_plan(plan)
        self.grouping_config = ClusteringTolerances(
