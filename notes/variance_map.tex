...
\item To evaluate the distance function, use \verb|VarianceMap.get_distance()| (in
 ...
 Besides \verb|D|, report \verb|max_r| and \verb|D_inflated| from
 \verb|measure_admissibility(inflate=True)|, since these distinguish an approximation which is
 nearly usable from one which is hopeless.
