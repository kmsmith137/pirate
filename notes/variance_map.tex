...
\section{{\tt PfAvarApproximation}, {\tt VarianceMapApproximation} [deprecated]}
\label{sec:variance_svd}

This appendix documents a pair of classes ({\tt PfAvarApproximation}, {\tt VarianceMapApproximation})
which implement a coarse-grained approximation to {\tt PfAvarExact}.
...
{\tt PfAvarApproximation}, {\tt VarianceMapApproximation} to be a deprecated, temporary
