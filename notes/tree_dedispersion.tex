...
% \subsection{Dedispersion with subbands}

% Define S,M. Give full array and per-subband shapes.

% Split into "case 1: l=0 or even s", and "case 2: l>0 and odd s".

% Comment on full range.
