...
I'd like to make a few changes to this section.
It's currently based on an approximation ({\tt class PfAvarApproximation}), whereas I'd
now prefer to compute $A$ exactly ({\tt class PfAvarExact}).
There are also some minor notational differences with the main text, such as ``transposing''
the definition of $A$.
Finally, the implementation is rough, and is in \verb|misc/throwaway*| scripts,
and I'd prefer a polished implementation in \verb|pirate_frb/slow_avar/PfVariance.py|.
