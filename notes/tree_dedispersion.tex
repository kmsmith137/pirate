...
\end{equation}
To prove that the nonrecursive definition (\ref{eq:DD_nonrecursive}) is equivalent to
our previous recursive definition in Eqs.\ (\ref{eq:DD_composition}), (\ref{eq:DD_DS}),
we use induction on $r$. (Details omitted for now.)
...
A proof of the splitting identity (\ref{eq:splitting}) is straightforward, if we use
the nonrecursive definition (\ref{eq:DD_nonrecursive}) as the starting point.
