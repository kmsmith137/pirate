...
The operator $\DS(\gamma)$ downsamples in time by a factor $2^\gamma$
...
\underbrace{\big( \DD(r'') \otimes 1 \big) 
 ...
 & \hspace{1cm} \circ \underbrace{\LAG\big[ 2^{r'}-1-f' \big] \circ \LS \circ \DS(\gamma)}_{\equiv \LDS(r',\gamma)}
\end{align}
...
We have now written the downsampled tree $U \circ \DD(r) \circ \DS(\gamma)$ as the
...
\subsection{More details: early triggers, stage1/stage2 trees, coalesced kernels}
