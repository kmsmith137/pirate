...
These tex notes are {\bf very incomplete} -- many important aspects of the dedisperser are still undocumented!
...
\subsection{What a mess}

Now that I've typed this all out, I'm realizing that my parameterization doesn't exactly
make it straightforward to configure a set of trees. At some point in the future, I'll probably
switch to something more intuitive.

In the meantime, if there are any simple changes that would be helpful, such as putting
more info in the \verb|dedispersion_plan| yaml, let me know.
