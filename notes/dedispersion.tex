...
{\tt PeakFindingKernelParams::xdm\_rank}, the count of ``extra DM'' bits folded into the argmax
token; a {\tt DedispersionTree} carries it only through {\tt dm\_downsampling} $= 2^{R+K}$.
