...
def autogenerated_kernel_basenames():
    ...
    for params in autogenerated_peak_finding_kernels():
        yield params.filename
        
    for kernel in autogenerated_pf_weight_reader_test_kernels():
        yield kernel.test_kernel_basename

    for kernel in autogenerated_pf_output_test_kernels():
        yield kernel.test_kernel_basename
...
def autogenerated_pf_weight_reader_test_kernels():
...
def autogenerated_pf_output_test_kernels():
