...
def autogenerated_peak_finding_kernels():
    # FIXME non-systematic examples for testing.
    fs = cuda_generator.FrequencySubbands(subband_counts = (3,2,1))
    yield cuda_generator.PeakFinder2('fp32', fs, E=8, Dcore=4, Dout=16, Tinner=4)
    yield cuda_generator.PeakFinder2('fp32', fs, E=16, Dcore=1, Dout=16, Tinner=1)
    # FIXME bring this back soon.
    # yield cuda_generator.PeakFinder2('fp16', fs, E=8, Dcore=8, Dout=16, Tinner=2)
