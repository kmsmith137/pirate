...
def autogenerated_cdd2_kernels():
    # (dtype, dd_rank, subband_counts, W, Dcore, Dout, Tinner)
    kernels = [
        ('fp32', 4, (0,0,1), 1, 16, 16, 1),
        ('fp16', 4, (0,0,1), 1, 16, 16, 1),
        ('fp16', 4, (0, 0, 1), 1, 4, 16, 2),
        ('fp32', 7, (0, 0, 0, 0, 1), 2, 4, 8, 2),
        ('fp16', 6, (0, 0, 0, 1), 1, 4, 16, 2),
        ('fp16', 7, (0, 0, 0, 0, 1), 16, 8, 16, 2),
        ('fp32', 3, (0, 0, 1), 8, 2, 4, 8),
        ('fp32', 6, (0, 0, 0, 1), 4, 8, 16, 1),
        ('fp16', 5, (0, 0, 0, 1), 16, 8, 16, 1),
        ('fp16', 3, (0, 0, 1), 2, 2, 16, 2),    
        ('fp32', 8, (0, 0, 0, 0, 1), 2, 1, 2, 8),
        ('fp32', 5, (0, 0, 0, 1), 2, 1, 2, 4),
        ('fp32', 6, (0, 0, 0, 1), 4, 1, 4, 2),
        ('fp16', 6, (0, 0, 0, 1), 1, 4, 16, 2),
        ('fp16', 8, (0, 0, 0, 0, 1), 16, 4, 8, 4),
        ('fp32', 5, (0, 0, 0, 1), 1, 4, 8, 4),
        ('fp32', 7, (0, 0, 0, 0, 1), 2, 4, 4, 4),
        ('fp16', 3, (0, 0, 1), 1, 8, 8, 2),
        ('fp16', 5, (0, 0, 0, 1), 8, 2, 2, 8),
        ('fp32', 8, (0, 0, 0, 0, 1), 4, 4, 16, 2),
        ('fp16', 8, (0, 0, 0, 0, 1), 4, 2, 8, 4),
        ('fp32', 4, (0, 0, 1), 1, 4, 16, 2),
    ]
    ...
    if False:
        ...
        for _ in range(20):
            ...
            print(f"('fp{nbits}', {dd_rank}, {subband_counts}, {W}, {Dcore}, {Dout}, {Tinner})")
