...
Reference for pirate's on-disk file formats and on-the-wire (network and RPC)
protocols. The YAML pages render an example/config file; the others describe a
wire protocol.
